...
function Navbar() {
  return (
    ...
    <div className="flex flex-row pl-5 pt-3 justify-between">
      ...
      <button className="pr-12  text-lg font-thin transition ease-in-out text-white delay-100 drop-shadow-lg drop-shadow-red-500  hover:-translate-y-1 hover:scale-110 hover:text-red-500 hover: shdaow-lg  duration-300 ..."><NavLink to="/headlines">HEADLINES</NavLink></button>
      ...
      <button className="pr-12 text-2xl hover:text-red-500 text-white hover:pb-2"><NavLink to="sign-in">SignIn</NavLink></button>
      <button className="pr-12 text-4xl hover:text-red-500 text-white hover:pb-2"><NavLink to="newpost">+</NavLink></button>
    </div>
    </nav>
  )
}
