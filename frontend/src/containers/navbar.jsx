...
function Navbar() {
  ...
  return (
    ...
    <div className="flex flex-row pl-5 pt-3 justify-between sm:flex sm:flex-column">
      <h1 className="text-4xl tracking-wide font-thin border-r-2 border-double text-white p-4 border-black"><NavLink to="/">News<span className="font-bold text-red-500">X</span></NavLink></h1>
